...
//            etMessage.setText("my fridge"); // Đặt text vào ô nhập
//            sendMessage();                  // Gọi hàm gửi
//        });
//
//        btnQuickHungry.setOnClickListener(v -> {
//            // Theo logic hiện tại, "I'm hungry" cũng nên kích hoạt gợi ý từ tủ lạnh
//            etMessage.setText("my fridge"); // Bạn có thể đổi thành "I'm hungry" nếu muốn AI xử lý khác
//            sendMessage();
//        });
//        // ------------------------------------
//
